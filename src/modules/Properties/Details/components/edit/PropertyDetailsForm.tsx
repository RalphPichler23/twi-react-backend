          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                placeholder="3"
                className="w-full pl-10 pr-4 py-3 border focus:outline-none border-gray-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
              />
              <svg className="absolute left-3 top-3.5 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
